...
const PROFILE_DEFINITIONS = [
  ...
  {
    key: 'paraerator-alpha',
    label: 'Paraerator Systems Launchpad',
    family: 'paraerator',
    siteCode: 'paraerator',
    layout: 'grid',
    palette: 'foundation',
    fileNames: [],
    tags: ['paraerator', 'propulsion', 'systems', 'aero', 'launch'],
    titleTokens: ['paraerator', 'propulsion systems', 'aero lab'],
    imageOrder: [0, 5, 1, 6, 2, 7, 3, 8, 4],
    videoOrder: [1, 2, 3, 0, 4, 5, 6],
