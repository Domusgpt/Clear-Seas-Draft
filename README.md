...
- [`docs/html-test-report.md`](docs/html-test-report.md) – nightly-smoke checklist that records asset resolution status for every
  HTML experience in the library. Regenerate with `node scripts/generate-html-test-report.js` when new pages or assets are added.
